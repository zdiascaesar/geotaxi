                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        _model.userExist = await queryUsersRecordOnce(
                          queryBuilder: (usersRecord) => usersRecord
                              .where(
                                'email',
                                isEqualTo: _model.emailFieldTextController.text,
                              )
                              .where(
                                'is_deleted',
                                isEqualTo: true,
                        ...
                        if (_model.userExist != null) {
                          var confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: const Text('The user was deleted'),
                                    content: const Text(
                                        'By pressing \"confirm\" you can restore all data, else the user\'s data will be cleaned in 72 hours'),
                                    actions: [
                                      TextButton(
