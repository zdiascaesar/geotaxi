  ...
  Widget build(BuildContext context) {
    return StreamBuilder<RidesRecord>(
      stream: RidesRecord.getDocument(widget.foundRide!.reference)
        ..listen((driver2RidesRecord) async {
          if (_model.driver2PreviousSnapshot != null &&
              !const RidesRecordDocumentEquality()
                  .equals(driver2RidesRecord, _model.driver2PreviousSnapshot)) {
          ...
          _model.driver2PreviousSnapshot = driver2RidesRecord;
        }),
      builder: (context, snapshot) {
        ...
        final driver2RidesRecord = snapshot.data!;
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          ...
                                          context.goNamed(
                                            'Driver1',
                                            queryParameters: {
                                              'dismissed': serializeParam(
                                                driver2RidesRecord.reference,
                                                ParamType.DocumentReference,
                                              ),
                                            }.withoutNulls,
                                          );
