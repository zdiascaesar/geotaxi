...
причину о... */
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          _model.checkedIssue =
                              FFLocalizations.of(context).getVariableText(
                            ruText: 'Не могу связаться с водителем',
                            enText: 'I can\'t contact the driver',
                            trText: 'Sürücüyle iletişim kuramıyorum',
                          );
                          safeSetState(() {});
                        },
                        child: Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          _model.checkedIssue =
                              FFLocalizations.of(context).getVariableText(
                            ruText: 'Водитель опаздывает',
                            enText: 'The driver is late',
                            trText: 'Sürücü geç kaldı',
                          );
                          safeSetState(() {});
                        },
                        child: Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: () async {
                          _model.checkedIssue =
                              FFLocalizations.of(context).getVariableText(
                            ruText: 'Цена не является разумной',
                            enText: 'The price is not reasonable',
                            trText: 'Bu fiyat uygun değil',
                          );
                          safeSetState(() {});
                        },
                        child: Row(
                      ...
                      InkWell(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(
                              FFLocalizations.of(context).getVariableText(
                                ruText: 'Неверный адрес поездки',
                                enText: 'Invalid Address',
                                trText: 'Geçersiz seyahat adresi',
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: (_model.checkedIssue == null ||
                            _model.checkedIssue == '')
                        ? null
                        : () async {
                            unawaited(
